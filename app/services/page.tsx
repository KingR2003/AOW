...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#050e2d] via-[#0a1a4a] to-[#0d2060] relative overflow-x-hidden">
      {/* Decorative background elements */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-10" style={{backgroundImage: "radial-gradient(circle at 20% 50%, #335f92 0%, transparent 50%), radial-gradient(circle at 80% 20%, #00418d 0%, transparent 40%)"}}></div>
      </div>
